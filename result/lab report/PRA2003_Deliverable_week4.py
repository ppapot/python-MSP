...
try:
    ...
    if directory == "":
        directory = "/Users/clotilde/Desktop/MAT2007/data"
    ...
    if nb_events.size > 0:        
        ...
        uncertainties_positive = np.std(averages_positive)
        uncertainties_negative = np.std(averages_negative)
        uncertainties_difference=np.std(mean_diff)
